...
\section{讨论}
  ...
  3. 从进化角度，肠炎患儿菌群在门水平上的组成大致类似；但具体到属水平则各不相同：HAEC患儿以肠球菌为优势菌属，总体组成成分与HD类似；IBD患儿各菌属丰度大致相当；NEC患儿肠道菌群构成则较为简单，且以克雷伯菌属为主导菌。另外，NEC和IBD组可见较高水平的韦荣氏球菌，后者与肠道黏膜上皮炎症反映密切相关。
